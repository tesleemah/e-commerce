      ...
      >
        <View className="flex-1 px-5 pt-12 pb-8">
          <View className="items-center mb-8">
            ...
            />
            <Text
              className={` text-xl font-medium mb-1 ${classes.textPrimary}`}
            >
              ShopApp
            </Text>
          ...
          <View className="justify-center mb-6">
            <Text
              className={`text-2xl font-medium text-center ${classes.textPrimary}`}
            >
              Welcome Back
            </Text>
            <Text
              className={`text-2xl font-medium text-center  ${classes.textSecondary}`}
            >
              Log In
            </Text>
          </View>
          ...
          <View className="items-end mb-6">
            <TouchableOpacity>
              <Text className={classes.tabActive}>Forgot Password</Text>
            </TouchableOpacity>
          </View>
          <View>
            <TouchableOpacity
              className={`${classes.btnPrimary} rounded-xl py-3.5 items-center`}
